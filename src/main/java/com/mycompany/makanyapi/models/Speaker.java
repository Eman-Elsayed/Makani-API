...
@NamedQueries({
    ...
    @NamedQuery(name = "Speaker.findByName", query = "SELECT s FROM Speaker s WHERE s.name = :name"),
    @NamedQuery(name = "Speaker.findByJob", query = "SELECT s FROM Speaker s WHERE s.job = :job")})
public class Speaker implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.makanyapi.models.Speaker[ id=" + id + " ]";
    }
